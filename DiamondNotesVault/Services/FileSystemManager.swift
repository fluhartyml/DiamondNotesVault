...
class FileSystemManager {
    ...
    func saveImage(_ image: UIImage, originalFilename: String? = nil, to mediaURL: URL) throws -> String {
        let filename: String
        let destURL: URL
    ...
    func loadNote(from fileURL: URL) throws -> (title: String, attributedContent: NSAttributedString) {
    ...
    /// Delete note file
    func deleteNote(at fileURL: URL) throws {
